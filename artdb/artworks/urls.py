...
urlpatterns = [
    ...
    path('artwork/<int:id>/edit_overlay.html', artwork_edit, name='artwork-edit'),
    path('artwork/<int:id>/collect_overlay.html', artwork_collect, name='artwork-collect'),
    path('collection/<int:id>.html', collection, name='collection'),
    path('collections.html', collections_list, name='collections-list'),
